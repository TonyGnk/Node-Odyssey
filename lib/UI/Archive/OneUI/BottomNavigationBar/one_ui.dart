/// This file contains the implementation of the OneUIBottomNavigationBar widget.
///
/// This widget is a custom implementation of the BottomNavigationBar widget
/// that follows the design of the OneUI interface. It provides a list of
/// OneUIBottomNavigationBarItem objects that can be tapped to change the
/// current active item. The widget also provides customization options for
/// the appearance of the navigation bar and its items.
///
/// This file also contains the implementation of the _OneUIBottomNavigationTile
/// and _Label widgets, which are used to display the individual items of the
/// navigation bar.
///
/// To use this widget, create a OneUIBottomNavigationBar object and pass in a
/// list of OneUIBottomNavigationBarItem objects as the `items` parameter. You
/// can also customize the appearance of the navigation bar and its items using
...
import 'onenavitem.dart';
import 'onenavsplash.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MediaQuery(
      data: mediaQueryData.copyWith(
        textScaler:
            TextScaler.linear(math.min(1.0, mediaQueryData.textScaleFactor)),
      ),
      child: Align(
        alignment: Alignment.center,
        // heightFactor: 1.0, top 2
...
class _OneUIBottomNavigationBarState extends State<OneUIBottomNavigationBar>
  ...
  Widget _createContainer(List<Widget> tiles) => DefaultTextStyle.merge(
